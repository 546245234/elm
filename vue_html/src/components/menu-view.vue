    ...
    <div class="menuview-menuview_2hUkG" style="height: 1252px;">
      ...
      <div class="menuview-menuviewMain_17K3g">
        <main class="menuview-main_i6fQ3">
          ...
          <section data-v-f433384a="" class="container menuview-menuList_JqDMu wrapper2" ref="wrapper2" style="height:300px;overflow:auto">
            <div data-v-f433384a="" class="scroller content"  style="height:auto;">
              <dl v-for="menu_item,index2 in menu" data-v-f433384a="" role="menu" class="item" :class="'item'+index2">
    ...
    async mounted(){
      ...
      this.$nextTick(() => { 
        ...
        for (let i = 0; i < foodList.length; i++) {
          this.scroll_arr.push(foodList[i].offsetTop)
        }

        this.scroll.on('scroll',(e)=>{
          // this.scrollY = Math.abs(Math.round(pos.y));
          for (let i = 0; i < this.scroll_arr.length; i++) {
            if(Math.abs(Math.round(e.y)) <= this.scroll_arr[i+1]){
              this.tab_index = i;
              break;
            }    
          }
