            ...
            <div className="slick-list draggable">
              <div className="slick-track" style={{"opacity":"1"}}>
                <div className="banner_cell radius has_title slick-slide" style={{"width":"747px"}}>
                  <a style={{"backgroundImage":"url(img/banner1.jpg)"}}> </a>
                  <div className="info">
                ...
                <div className="banner_cell radius has_title slick-slide" style={{"width":"747px"}}>
                  <a style={{"backgroundImage":"url(img/banner2.jpg)"}}> </a>
                ...
                <div className="banner_cell radius has_title slick-slide" style={{"width":"747px"}}>
                  <a style={{"backgroundImage":"url(img/banner3.jpg)"}}> </a>
                  <div className="info">
                    <div className="abstract">
                      趣头条，在巨头曾经忽视的下沉市场狂奔
                    </div>
                ...
                <div className="banner_cell radius has_title slick-slide" style={{"width":"747px"}}>
                  <a style={{"backgroundImage":"url(img/banner4.jpg)"}}> </a>
                  <div className="info">
                    <div className="abstract">
                ...
                <div className="banner_cell radius has_title slick-slide" style={{"width":"747px"}}>
                  <a style={{"backgroundImage":"url(img/banner5.jpg)"}}> </a>
                  <div className="info">
                    <div className="abstract">
                      今日值得看——36氪全天热度文章
                    </div>
                ...
                style={{"width":"747px"}}>
                  <a style={{"backgroundImage":"url(img/banner6.jpg)"}}> </a>
                  <div className="info">
                    <div className="abstract">
