        ...
        return (
            <header className="common-header J_commonHeaderWrapper">
                ...
                <div className="pc-nav">
                    ...
                    <a className="headericon-header-search J_searchTrigger"> </a>
                    <a className="headericon-header-menu J_menuTrigger"> </a>
                    </div>
                    <nav>
                    <ul className="J_navList">
                        ...
                        <a className="trigger-hide pointer-box">
                            联系我们
                            <i className="headericon-arrow-drop-down"></i>
                        </a>
                        </li>
                ...
                <div className="right-col J_rightNavWrapper">
                    ...
                    <li className="login-actions">
                        ...
                        <div className="group">
                            ...
                            <a className="J_login login-link">
                            登录
                            </a>
                        </div>
                        ...
                        <div className="group">
                            ...
                            <a className="J_signup login-link">
                            注册
                            </a>
                        </div>
                        </div>
                ...
                <div className="items-wrapper" style={{"transform":"translate(0px, -100%)"}}>
                    ...
                    <span className="product-icon">
                        <img src="/img/ic_report@2x-bc294.png" alt=""/>
                    </span>
                    ...
                    <a className="item">
                    <span className="product-icon">
                        <img src="/img/ic_activity@2x-966df.png" alt=""/>
                    </span>
                    <span className="product-name">
                        近期活动
                    </span>
                    ...
                    <a className="item">
                    <span className="product-icon">
                        <img src="/img/jingzhun-logo-1-614ef.png" alt=""/>
                    </span>
                    <span className="product-name">
                        鲸准
                    </span>
                    ...
                    <a className="item">
                    <span className="product-icon">
                        <img src="/img/gn8pet9cnj7jc1vw.png" alt=""/>
                    </span>
                    <span className="product-name">
                        氪空间
                    </span>
                ...
                <div className="items-wrapper" style={{"transform":"translate(0px, -100%)"}}>
                    <a className="item">
                    <span className="product-icon">
                        <img src="/img/ic_cooperation@2x-4c322.png" alt=""/>
                    </span>
                    <span className="product-name">
                        VClub投资机构合作
                    </span>
                    ...
                    <a className="item">
                    <span className="product-icon">
                        <img src="/img/jingzhun-logo-2-3ef0e.png" alt=""/>
                    </span>
                    <span className="product-name">
                        鲸准 · 个人版
                    </span>
                    ...
                    <a className="item">
                    <span className="product-icon">
                        <img src="/img/jingzhun-logo-3-20458.png" alt=""/>
                    </span>
                    <span className="product-name">
                        鲸准 · 机构版
                    </span>
                ...
                <div className="items-wrapper" style={{"transform":"translate(0px, -100%)"}}>
                    <a className="item">
                    <span className="product-icon">
                        <img src="/img/ic_submission@2x-8d888.png" alt=""/>
                    </span>
                    <span className="product-name">
                        我要投稿
                    </span>
                ...
                >
                    <span className="product-icon">
                        <img src="/img/ic_cooperation2@2x-9185b.png" alt=""/>
                    </span>
                    <span className="product-name">
                        商务合作
                    </span>
                    ...
                    <a className="item">
                    <span className="product-icon">
                        <img src="/img/1is2ilcd29dsxx07.png" alt=""/>
                    </span>
                    <span className="product-name">
                        城市加盟
                    </span>
                ...
                <div className="items-wrapper" style={{"transform":"translate(0px, -100%)"}}>
                    <a className="item app-item">
                    <span className="product-icon">
                        <img src="/img/ic_36kr@2x-9a9cd.png" alt=""/>
                    </span>
                    <span className="product-name">
                        36氪
                    </span>
                    <span className="product-download">
                        ...
                        <img src="/img/QR_36k@2x-c4e8e.png" alt=""/>
                        </span>
                    ...
                    <span className="product-download">
                        <span className="product-qr">
                        <img src="/img/jingzhun-qrcode-3a27a.png" alt=""/>
                        </span>
                        <span className="product-version">
                        iPhone&amp;Android
                        </span>
