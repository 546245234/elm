    ...
    render(){
        ...
        <footer className="common-footer">
            ...
            <section className="product-section">
                ...
                <a className="item">
                    <span className="product-icon">
                    <img src="/img/4dvu0zykchyo7hs2.png" alt="" />
                    </span>
            ...
            <section className="link-section">
                ...
                <a rel="nofollow">寻求报道</a>
                <a rel="nofollow">我要投稿</a>
                <a rel="nofollow">城市加盟</a>
                <a rel="nofollow">加入我们</a>
                <a rel="nofollow">APP下载</a>
                </div>
            </section>
            <section className="partner-section">
                ...
                <li>
                    <a rel="nofollow" className="external">
            ...
            <div className="container">
                ...
                <a className="safe-logo">
                    <img alt="品牌宝" src="/img/gw_83x30.png" />
                </a>
                <br/>
                </div>
                <div className="share">
                <a className="iconfooter-weibo"> </a>
                <a className="iconfooter-rss"> </a>
                </div>
            </div>
            </div>
        </footer>
